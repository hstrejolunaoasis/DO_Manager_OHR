  ...
  return (
    <div className="flex items-center space-x-2">
      <button
        ...
        disabled={value <= min}
        className="p-1 rounded-md text-text-tertiary hover:text-text-secondary hover:bg-card-hover dark:hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed"
